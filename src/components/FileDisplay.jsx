  ...
  return (
    <main className='flex-1 p-4 flex flex-col gap-3 sm:gap-4 text-center justify-center pb-20 w-72 sm:w-96 max-w-full mx-auto'>
      ...
      <div className="flex items-center justify-between gap-4">
        <button onClick={handleAudioReset} className='text-slate-400 hover:text-teal-600 duration-200'>Reset</button>
        <button onClick={handleFormSubmission} className='specialBtn px-3 p-2 rounded-lg text-teal-400 flex items-center gap-2 font-medium'>
          <p>Transcribe</p>
